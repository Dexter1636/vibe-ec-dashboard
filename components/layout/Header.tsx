...
export type TabType = 'home' | 'batch-generate' | 'tiktok' | 'image-generation' | 'template-library' | 'settings';
...
const tabs = [
  ...
  { id: 'image-generation' as const, label: '图片生成', icon: '🎨', description: 'AI绘图' },
